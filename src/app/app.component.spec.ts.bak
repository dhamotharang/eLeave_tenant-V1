...
describe('AppComponent', () => {
  ...
  it('should have menu labels', async () => {
    ...
    expect(menuItems[3].textContent).toContain('Customers');
  ...
  it('should have urls', async () => {
    ...
    expect(menuItems.length).toEqual(2);
    expect(menuItems[0].getAttribute('ng-reflect-router-link')).toEqual('/main/home');
    ...
    expect(menuItems[3].getAttribute('ng-reflect-router-link')).toEqual('/main/customers');
